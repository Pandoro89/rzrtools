...
# deploy.rb
set :linked_dirs, fetch(:linked_dirs, []).push('log', 'keys', 'certificates', 'challenge', 'tmp/pids', 'tmp/cache', 'tmp/sockets', 'vendor/bundle', 'public/system', 'public/uploads', 'public/static')
